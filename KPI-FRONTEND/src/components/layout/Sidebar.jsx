...
const supervisorNav = [
  { to: '/supervisor/dashboard', icon: LayoutGrid, label: 'Tableau de bord' },
  { to: '/supervisor/agents', icon: Users, label: 'Agents' },
  { to: '/supervisor/tickets', icon: Search, label: 'Explorateur de tickets' },
  { to: '/supervisor/kpi-explorer', icon: BarChart3, label: 'Explorateur KPI' },
...
const agentNav = [
  { to: '/agent/dashboard', icon: LayoutGrid, label: 'Mon tableau de bord' },
  { to: '/agent/kpi', icon: Gauge, label: 'Mes KPI' },
  { to: '/agent/nps', icon: Star, label: 'Mon NPS' },
  { to: '/agent/coaching', icon: ClipboardList, label: 'Mon Coaching' },
];
      ...
      <nav style={{ flex: 1, padding: '8px 12px', display: 'flex', flexDirection: 'column', gap: 2, overflowY: 'auto' }}>
        ...
        {nav.map(item => {
          ...
          return (
            ...
            >
              <Icon size={16} style={{ width: 20, flexShrink: 0 }} />
